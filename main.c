...
void inir(void)
{
  ...
  soundflag=1;//GetINIBool(INI_SOUND_SETTINGS,"SoundOn",TRUE,ININAME);
  musicflag=1;//GetINIBool(INI_SOUND_SETTINGS,"MusicOn",TRUE,ININAME);
  sound_device=1;//(int)GetINIInt(INI_SOUND_SETTINGS,"Device",DEF_SND_DEV,ININAME);
